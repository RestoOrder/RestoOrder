package com.example.restoorder.Adapter;
...
import com.example.restoorder.Activity.ListFoodsActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewholder holder, int position) {
     ...
     switch (position){
        ...
        int drawbaleResourceId=context.getResources().getIdentifier(items.get(position).getImagePath(),"drawable",holder.itemView.getContext().getPackageName());
        Glide.with(context)
